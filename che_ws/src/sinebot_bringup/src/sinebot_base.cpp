...
void SineBotBase::spinOnce(const SineBotVel& vel)
{
    ros::Time current_time = ros::Time::now();

    linear_velocity_x_ = vel.linear_vel_x.vel;
    linear_velocity_y_ = vel.linear_vel_y.vel;
    angular_velocity_z_ = vel.angular_vel_z.vel;
